...
//        assertEquals("Champion Of Golf", actualMembership.getCurrentTournament());
//        assertSame(ofEpochDayResult, actualMembership.getDuration());
//        assertEquals(897L, actualMembership.getId());
//        assertEquals("Trial", actualMembership.getMembershipType());
//        assertEquals("Lesser Champion Of Golf", actualMembership.getPastTournament());
//        assertSame(ofEpochDayResult1, actualMembership.getStartDate());
//        assertEquals("Super Duper Champion Of Golf", actualMembership.getUpcomingTournament());
//    }
//
//    @Test
